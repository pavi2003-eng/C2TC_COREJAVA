package com.tns.ifet.dayfifteen.comaparableandcomparator;
...
//		Collections.sort(studentList);
		...
		Person a = new Person("Abhijit", "Mumbai");
		personList.add(a);

		a = new Person("Milind", "Pune");
		personList.add(a);

		a = new Person("Saurav", "Bangalore");
		personList.add(a);

		a = new Person("Madhur", "Delhi");
		personList.add(a);
